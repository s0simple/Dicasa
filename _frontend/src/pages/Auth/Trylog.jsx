  ...
  return (
    <>
      <div>
        ...
        <div className="h-screen relative flex flex-col space-y-10  items-center">
          <div className=" mt-20 shadow-none rounded  min-w-[30%]">
            <div className=" flex flex-col space-y-8">
              {" "}
              <h1 className="text-3xl font-bold leading-normal">Sign in</h1>
              <button className="max-h-[12rem] border space-x-4 flex justify-center items-center p-2 w-[14rem] rounded border-gray-400 space-between">
            ...
            <form className="space-y-6 mt-5" onSubmit={(e) => handleSubmit(e)}>
              {/* <div className="mb-4 relative input-field ">
          <input
            id="email"
            className="input w-full bg-color rounded px-3 border border-gray-500 pt-5 pb-2 focus:outline-none active:outline-none input-height"
            type="text"
            autoFocus=""
            name="email"
            value={inputs.email}
          ...
          <label
            htmlFor="email"
            className="placeholder name-label absolute mb-0 -mt-2 pt-4 pl-3 leading-tighter text-gray-500 text-base mt-2 cursor-text"
          >
            Email
          </label>
        </div> */}
          ...
          <input
            id="password"
            className="w-full bg-color rounded px-3 pt-5 outline-none pb-2 focus:outline-none active:outline-none name-input active:border-blue-500 input-height"
            type="password"
            name="password"
            value={inputs.password}
            onChange={handlechange}
          ...
          <label
            htmlFor="password"
            className="name-label absolute mb-0 -mt-2 pt-4 pl-3 leading-tighter text-gray-500 text-base mt-2 cursor-text"
          >
            Password
          </label>
          <a
          ...
          >
            show
              ...
              <div className="">
                <a className="font-medium underline " href="dee.com">
                  Forgot password?
                </a>
              </div>
              <button
                type="submit"
                className="w-full  text-center text-lg bg-blue-600 hover:bg-blue-700 rounded text-white py-3 font-medium input-height"
              >
                Sign in
              </button>
            </form>
            <p className="notify_join  pt-5 text-center">
              Don't have an account?{" "}
              <Link
                className="  hover:text-blue-700 hover:underline font-medium underline"
                to={"/register"}
              >
                Create one
              </Link>
